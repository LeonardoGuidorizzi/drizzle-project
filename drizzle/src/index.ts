...
import { usersTable } from "./db/entities/user/schema";
 ...
 * 1: criar tabela family(X)30
 * 2: criar uma pasta para entidades drizzle e mover as tabelas para la(X)30
 * 3: adicionar vinculo de family vs usuarios(x)42
